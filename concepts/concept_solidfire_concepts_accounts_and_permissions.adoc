...
The link:../concepts/concept_intro_clusters.html#authoritative-storage-clusters[authoritative storage cluster] is the storage cluster that NetApp Hybrid Cloud Control uses to authenticate users.
