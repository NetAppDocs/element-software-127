...
* If you are adding more than one storage node, you have read and understood the limitations of the link:../concepts/concept_intro_clusters.html#authoritative-storage-clusters[Authoritative cluster] and multiple storage cluster support.
+
...
* link:../concepts/concept_intro_clusters.html#authoritative-storage-clusters[Authoritative cluster]
